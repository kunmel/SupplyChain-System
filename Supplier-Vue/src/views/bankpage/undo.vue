...
<el-dialog title="更新融资状态" :visible.sync="dialogFormVisible">
  ...
  <div slot="footer" class="dialog-footer">
    ...
    <el-button type="danger" @click="rejectApply()">拒绝申请</el-button>
  </div>
</el-dialog>
  </div>
</template>
...
<script>
import { UpdateFinanceStatus,QueryFinance} from '@/api/excel'
export default {
  ...
  methods: { 
    passApply(){
      ...
      UpdateFinanceStatus(data).then(res => {
        console.log("UpdateFinanceStatus",res)
        this.dialogFormVisible = false
        this.$message({
                  message: '审批融资成功',
                  type: 'success'
                });
        this.$router.push({ path: "/bankpage/done" });
      })
